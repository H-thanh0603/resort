...
function CheckoutInner() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-5 py-16">
      <p className="label-uppercase text-[11px] text-[#8c6d46]">Thanh toán</p>
      ...
      <div className="card-lux p-8 mt-6 space-y-4">
        ...
        <p className="text-xs text-[#444748]">Cấu hình VNPAY_TMN_CODE + VNPAY_HASH_SECRET trong .env để chạy thanh toán thật.</p>
      </div>
    </div>
  );
}
